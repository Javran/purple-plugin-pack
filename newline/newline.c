...
init_plugin(GaimPlugin *plugin) {
	...
	info.summary = _("Prepends a newline to displayed messages.");
	info.description = _("Prepends a newline to messages so that the text "
						 "of the message appears below the screen name in "
